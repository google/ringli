...
// in //util/compression/ringli/enc/arith_encode.h

#ifndef COMMON_DISTRIBUTIONS_H_
#define COMMON_DISTRIBUTIONS_H_
...
struct Prob {
  static constexpr int kInitProb = 128;
  static constexpr int kInitProbCount = 3;
  Prob()
      : prob8(kInitProb),
  ...
  void Add(int val) {
    ...
    prob8 = std::max<uint32_t>(1, ((uint32_t)(divlut[total]) * count) >> 17);
